...
madlib = '''
Once upon a time, in a kingdom far away from her own land, {first_name} awoke with a daze. {pronoun} looked up and
...
{first_name} had climbed on to the carriage, and quickly replied "The ENCHANTED FOREST! I need to find some {travel[opt1]}, {travel[opt2]}, or {travel[opt3]}!"

{friend_name} looked at his riding companion strangely, and knew his first instincts were right. Something was not right with this person. He wanted to tell the
Evil Queen at once, so as to maybe get a reward. He hurried on to the local tavern, and they rode in silence.

{first_name} realized was not in {city} anymore and would have to relay on her fairytale knowledge, if she wanted to arrive home safely!

After what seemed like hours, they finally arrived at the tavern. {friend_name} said "This is where I leave you. I'm sorry but I must be going. I wish you safe travels, hope you find your way."

{first_name} said "Thank you my friend, I understand."

{first_name} stepped into the tavern, and couldn't believe what she say. Never before had she seen real live {creatures} and other mystical creatures before.
